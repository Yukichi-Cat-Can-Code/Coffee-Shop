...
-- Dumping data for table coffeeshop.admins
INSERT INTO `admins` (`ID`, `admin_name`, `admin_email`, `admin_password`, `admin_role`, `created_at`) VALUES
  (6, 'Mai Minh', 'maiminh123@gmail.com', '$2y$10$mxL3UJkPvK45LXIDz0qXHOpA9yPYTeW8RIJjUciiry8l/gZdJ/w0e', 'admin', '2025-06-21 16:21:29'),
  (10, 'Super Admin', 'super_admin@gmail.com', '$2y$10$qXzxwsXCh3DhM3UEale.NOtG/B6V0ZqLFRRhtt6bQOKPfqEcVGX5i', 'super_admin', '2025-06-30 10:34:32');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `membership_points` decimal(10,2) NOT NULL DEFAULT 0.00,
  `membership_tier` varchar(20) NOT NULL DEFAULT 'none',
  `tier_updated_at` timestamp NULL DEFAULT NULL,
  `points_reset_date` date NULL DEFAULT NULL,
  `last_order_date` date DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`ID`),
  KEY `idx_users_user_email` (`user_email`),
  KEY `idx_users_user_phone` (`user_phone`),
  KEY `idx_membership_tier` (`membership_tier`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table coffeeshop.users
INSERT INTO `users` (`ID`, `user_name`, `user_email`, `user_pass`, `user_phone`, `street_address`, `apartment`, `town_city`, `postcode`, `points`, `membership_points`, `membership_tier`, `tier_updated_at`, `points_reset_date`, `last_order_date`, `created_at`) VALUES
  (1, 'Mai Minh', 'maiminh@gmail.com', '$2y$10$QBDWZTQUiCohLY95woJK3ew/Aez7HSpQsgmfGLz9AXivCTA02czXy', '0912345678', '123 Lê Lợi', 'Tầng 2', 'Hà Nội', '100000', 28, 150.00, 'bronze', '2025-06-01 00:00:00', '2026-06-01', '2025-07-03', '2024-01-24 21:09:51'),
  (2, 'Ngọc Anh', 'ngocanh@gmail.com', '$2y$10$abCdEfGhIjKlMnOpQrStUv1234567890AbCdEfGhIjK', '0987654321', '45 Trần Phú', 'A12', 'Hải Phòng', '180000', 15, 180.00, 'bronze', '2025-06-01 00:00:00', '2026-06-01', '2025-06-06', '2025-06-01 00:00:00'),
  (3, 'Quang Hải', 'quanghai@gmail.com', '$2y$10$abCdEfGhIjKlMnOpQrStUv1234567890AbCdEfGhIjK', '0901234567', '78 Nguyễn Huệ', 'B5', 'Đà Nẵng', '550000', 32, 320.00, 'silver', '2025-06-02 01:15:00', '2026-06-02', '2025-06-09', '2025-06-02 01:15:00'),
  (4, 'Thu Trang', 'thutrang@gmail.com', '$2y$10$abCdEfGhIjKlMnOpQrStUv1234567890AbCdEfGhIjK', '0934567890', '12 Lý Thường Kiệt', 'C3', 'Hà Nội', '120000', 18, 190.00, 'bronze', '2025-06-03 02:30:00', '2026-06-03', '2025-06-12', '2025-06-03 02:30:00'),
  (5, 'Văn Nam', 'vannam@gmail.com', '$2y$10$abCdEfGhIjKlMnOpQrStUv1234567890AbCdEfGhIjK', '0945678901', '89 Lê Duẩn', '', 'Huế', '530000', 21, 210.00, 'silver', '2025-06-04 03:45:00', '2026-06-04', '2025-06-15', '2025-06-04 03:45:00'),
  (6, 'Minh Châu', 'minhchau@gmail.com', '$2y$10$abCdEfGhIjKlMnOpQrStUv1234567890AbCdEfGhIjK', '0956789012', '56 Phan Đình Phùng', 'Tầng 1', 'Hà Nội', '100000', 29, 290.00, 'silver', '2025-06-05 05:00:00', '2026-06-05', '2025-06-18', '2025-06-05 05:00:00'),
  (7, 'Hà Phương', 'haphuong@gmail.com', '$2y$10$abCdEfGhIjKlMnOpQrStUv1234567890AbCdEfGhIjK', '0967890123', '34 Nguyễn Trãi', 'P.202', 'TP.HCM', '700000', 14, 140.00, 'bronze', '2025-06-06 06:15:00', '2026-06-06', '2025-06-20', '2025-06-06 06:15:00'),
  (8, 'Tuấn Kiệt', 'tuankiet@gmail.com', '$2y$10$abCdEfGhIjKlMnOpQrStUv1234567890AbCdEfGhIjK', '0978901234', '67 Lý Nam Đế', '', 'Đà Nẵng', '550000', 40, 520.00, 'gold', '2025-06-07 07:30:00', '2026-06-07', '2025-06-23', '2025-06-07 07:30:00'),
  (9, 'Lan Hương', 'lanhuong@gmail.com', '$2y$10$abCdEfGhIjKlMnOpQrStUv1234567890AbCdEfGhIjK', '0989012345', '23 Điện Biên Phủ', 'A8', 'Hải Phòng', '180000', 17, 170.00, 'bronze', '2025-06-08 08:45:00', '2026-06-08', '2025-06-26', '2025-06-08 08:45:00'),
  (10, 'Bảo Long', 'baolong@gmail.com', '$2y$10$abCdEfGhIjKlMnOpQrStUv1234567890AbCdEfGhIjK', '0990123456', '11 Nguyễn Văn Cừ', '', 'Hà Nội', '100000', 24, 240.00, 'silver', '2025-06-09 10:00:00', '2026-06-09', '2025-06-29', '2025-06-09 10:00:00'),
  (11, 'ABCD', 'abcd@gmail.com', '$2y$10$iYG19XY5w4OG8ytVg5tO6OpsoBt5nFNNPDTtDwh0JTbdNW91jvF.a', NULL, NULL, NULL, NULL, NULL, 0, 0.00, 'none', NULL, NULL, NULL, '2025-07-04 01:28:26'),
  (12, 'ABCDEF', 'abcdef@gmail.com', '$2y$10$20Tz7f3an6/xCmTyrea3Cuvj0Pdaju4yEz/x5vIERtBdIAhR8NrQO', NULL, NULL, NULL, NULL, NULL, 0, 0.00, 'none', NULL, NULL, NULL, '2025-07-04 01:29:59');
...
-- Dumping data for table coffeeshop.product
...
-- Dumping data for table coffeeshop.bookings
INSERT INTO `bookings` (`ID`, `user_id`, `first_name`, `last_name`, `date`, `time`, `phone_number`, `message`, `status`, `created_at`) VALUES
  ...
  (53, 1, 'Mai', 'Minh', '2025-07-08', '18:45', '1234567890', 'Đặt bàn test', 'Pending', '2025-07-01 16:43:31');
...
-- Dumping data for table coffeeshop.cart
...
-- Dumping data for table coffeeshop.orders
...
-- Dumping data for table coffeeshop.order_details
...
CREATE TABLE IF NOT EXISTS `pos_orders` (
  ...
  `final_amount` decimal(10,3) NOT NULL DEFAULT 0.000,
  ...
  KEY `idx_pos_orders_order_status` (`order_status`),
  KEY `idx_pos_orders_payment_status` (`payment_status`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table coffeeshop.pos_orders
INSERT INTO `pos_orders` (`order_id`, `table_number`, `order_type`, `total_amount`, `discount_amount`, `tax_amount`, `final_amount`, `payment_status`, `order_status`, `customer_name`, `customer_phone`, `admin_id`, `created_at`, `completed_at`, `customer_id`) VALUES
  (1, 'A1', 'Tại quán', 120000.000, 12000.000, 10800.000, 118800.000, 'Đã thanh toán', 'Hoàn thành', 'Mai Minh', '0912345678', 6, '2025-07-01 10:30:00', '2025-07-01 11:15:00', 1),
  (2, NULL, 'Mang đi', 85000.000, 4250.000, 8075.000, 88825.000, 'Đã thanh toán', 'Hoàn thành', 'Ngọc Anh', '0987654321', 6, '2025-07-02 14:20:00', '2025-07-02 14:40:00', 2),
  (3, 'B3', 'Tại quán', 225000.000, 33750.000, 19125.000, 210375.000, 'Đã thanh toán', 'Hoàn thành', 'Quang Hải', '0901234567', 10, '2025-07-02 18:00:00', '2025-07-02 19:30:00', 3),
  (4, NULL, 'Giao hàng', 175000.000, 8750.000, 16625.000, 182875.000, 'Đã thanh toán', 'Hoàn thành', 'Thu Trang', '0934567890', 10, '2025-07-03 09:15:00', '2025-07-03 10:00:00', 4),
  (5, 'C2', 'Tại quán', 320000.000, 32000.000, 28800.000, 316800.000, 'Đã thanh toán', 'Hoàn thành', 'Văn Nam', '0945678901', 6, '2025-07-03 20:45:00', '2025-07-03 22:00:00', 5);
...
CREATE TABLE IF NOT EXISTS `pos_order_items` (
  ...
  KEY `order_id` (`order_id`),
  KEY `product_id` (`product_id`),
  KEY `idx_pos_order_items_created_at` (`created_at`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table coffeeshop.pos_order_items
INSERT INTO `pos_order_items` (`item_id`, `order_id`, `product_id`, `product_name`, `quantity`, `unit_price`, `size`, `customizations`, `subtotal`, `created_at`) VALUES
  (1, 1, 1, 'Mocha Ả Rập Đặc Biệt', 1, 55000.000, 'Vừa', NULL, 55000.000, '2025-07-01 10:30:00'),
  (2, 1, 2, 'Mocha Đêm Khuya (Espresso, Sô-cô-la Đen và Bạc Hà)', 1, 65000.000, 'Lớn', 'Thêm đá', 65000.000, '2025-07-01 10:30:00'),
  (3, 2, 4, 'Bánh Âu việt quốc', 1, 35000.000, NULL, NULL, 35000.000, '2025-07-02 14:20:00'),
  (4, 2, 1, 'Mocha Ả Rập Đặc Biệt', 1, 50000.000, 'Nhỏ', 'Ít đường', 50000.000, '2025-07-02 14:20:00'),
  (5, 3, 5, 'Bò bít tết 5 sao', 2, 90000.000, NULL, 'Chín vừa', 180000.000, '2025-07-02 18:00:00'),
  (6, 3, 2, 'Mocha Đêm Khuya (Espresso, Sô-cô-la Đen và Bạc Hà)', 1, 45000.000, 'Nhỏ', NULL, 45000.000, '2025-07-02 18:00:00'),
  (7, 4, 3, 'Burger bò một trứng', 2, 50000.000, NULL, 'Không hành', 100000.000, '2025-07-03 09:15:00'),
  (8, 4, 1, 'Mocha Ả Rập Đặc Biệt', 1, 75000.000, 'Siêu lớn', 'Thêm whipped cream', 75000.000, '2025-07-03 09:15:00'),
  (9, 5, 5, 'Bò bít tết 5 sao', 2, 90000.000, NULL, 'Tái', 180000.000, '2025-07-03 20:45:00'),
  (10, 5, 4, 'Bánh Âu việt quốc', 4, 35000.000, NULL, NULL, 140000.000, '2025-07-03 20:45:00');
...
-- Dumping data for table coffeeshop.payments
INSERT INTO `payments` (`payment_id`, `order_id`, `payment_method`, `amount`, `transaction_id`, `card_last_digits`, `status`, `admin_id`, `payment_date`) VALUES
  (1, 1, 'Tiền mặt', 118800.000, NULL, NULL, 'Hoàn thành', 6, '2025-07-01 11:15:00'),
  (2, 2, 'Thẻ tín dụng', 88825.000, 'CARD-20250702-001', '4321', 'Hoàn thành', 6, '2025-07-02 14:40:00'),
  (3, 3, 'Tiền mặt', 210375.000, NULL, NULL, 'Hoàn thành', 10, '2025-07-02 19:30:00'),
  (4, 4, 'Ví điện tử', 182875.000, 'MOMO-20250703-002', NULL, 'Hoàn thành', 10, '2025-07-03 10:00:00'),
  (5, 5, 'Thẻ tín dụng', 316800.000, 'CARD-20250703-003', '5678', 'Hoàn thành', 6, '2025-07-03 22:00:00');
...
-- Dumping data for table coffeeshop.reviews
...
-- Bảng mức hạng thành viên
CREATE TABLE IF NOT EXISTS `membership_tiers` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `tier_name` varchar(50) NOT NULL,
  `tier_key` varchar(20) NOT NULL,
  `min_points` float NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `membership_rules` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `points_per_order` float NOT NULL DEFAULT 0.1,
  `reset_period_months` int(11) NOT NULL DEFAULT 12,
  `retention_threshold_percent` int(11) NOT NULL DEFAULT 30,
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dữ liệu ban đầu cho bảng membership_rules
INSERT INTO `membership_rules` (`points_per_order`, `reset_period_months`, `retention_threshold_percent`) VALUES
(0.1, 12, 30);

-- Bảng lưu trữ lịch sử điểm thành viên
...
-- Audit log để lưu hoạt động hệ thống
...
ADD CONSTRAINT `fk_pos_order_items_order_id`
...
ADD CONSTRAINT `fk_membership_points_user_id`
FOREIGN KEY (`user_id`) REFERENCES `users` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

-- 1. Liên kết membership_tier trong users với membership_tiers
ALTER TABLE `users`
ADD CONSTRAINT `fk_users_membership_tier`
FOREIGN KEY (`membership_tier`) REFERENCES `membership_tiers` (`tier_key`) 
ON DELETE RESTRICT ON UPDATE CASCADE;

-- 2. Liên kết customer_id trong pos_orders với users
ALTER TABLE `pos_orders`
ADD CONSTRAINT `fk_pos_orders_customer_id`
FOREIGN KEY (`customer_id`) REFERENCES `users` (`ID`) 
ON DELETE SET NULL ON UPDATE CASCADE;

-- 3. Liên kết admin_id trong membership_points với admins
ALTER TABLE `membership_points`
ADD CONSTRAINT `fk_membership_points_admin_id`
FOREIGN KEY (`admin_id`) REFERENCES `admins` (`ID`) 
ON DELETE SET NULL ON UPDATE CASCADE;

-- 4. Liên kết order_id trong membership_points với orders
ALTER TABLE `membership_points`
ADD CONSTRAINT `fk_membership_points_order_id`
FOREIGN KEY (`order_id`) REFERENCES `orders` (`ID`) 
ON DELETE SET NULL ON UPDATE CASCADE;

-- 5. Liên kết order_id trong reviews với orders
ALTER TABLE `reviews`
ADD CONSTRAINT `fk_reviews_order_id`
FOREIGN KEY (`order_id`) REFERENCES `orders` (`ID`) 
ON DELETE SET NULL ON UPDATE CASCADE;

-- 6. Liên kết admin_id trong payments với admins
ALTER TABLE `payments`
ADD CONSTRAINT `fk_payments_admin_id`
FOREIGN KEY (`admin_id`) REFERENCES `admins` (`ID`)
ON DELETE RESTRICT ON UPDATE CASCADE;

-- Thêm cột rule_id vào bảng membership_tiers để liên kết với quy tắc cụ thể (nếu cần)
ALTER TABLE `membership_tiers` 
ADD COLUMN `rule_id` int(10) NULL DEFAULT NULL AFTER `status`;

-- Tạo khóa ngoại từ membership_tiers đến membership_rules
ALTER TABLE `membership_tiers`
ADD CONSTRAINT `fk_membership_tiers_rule_id`
FOREIGN KEY (`rule_id`) REFERENCES `membership_rules` (`id`)
ON DELETE SET NULL ON UPDATE CASCADE;

-- Tạo ràng buộc cho các giá trị trong bảng membership_rules
ALTER TABLE `membership_rules`
ADD CONSTRAINT `chk_points_per_order_positive` 
CHECK (`points_per_order` >= 0);

ALTER TABLE `membership_rules`
ADD CONSTRAINT `chk_reset_period_positive` 
CHECK (`reset_period_months` > 0);

ALTER TABLE `membership_rules`
ADD CONSTRAINT `chk_retention_threshold_valid` 
CHECK (`retention_threshold_percent` BETWEEN 0 AND 100);

-- Nếu bạn muốn đảm bảo chỉ có một quy tắc hoạt động, thêm cột active
ALTER TABLE `membership_rules`
ADD COLUMN `is_active` BOOLEAN NOT NULL DEFAULT TRUE AFTER `retention_threshold_percent`;

-- Sửa lỗi trigger bằng cách thêm DELIMITER
DELIMITER //

CREATE TRIGGER `ensure_single_active_rule`
BEFORE INSERT ON `membership_rules`
FOR EACH ROW
BEGIN
    IF NEW.is_active = TRUE THEN
        UPDATE `membership_rules` SET `is_active` = FALSE WHERE `is_active` = TRUE;
    END IF;
END//
